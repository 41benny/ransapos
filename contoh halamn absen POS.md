...
<title>Domsteak POS Attendance V2</title>
<script src="https://cdn.tailwindcss.com?plugins=forms,container-queries"></script>
<link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&amp;display=swap" rel="stylesheet"/>
<link href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:wght,FILL@100..700,0..1&amp;display=swap" rel="stylesheet"/>
<style type="text/tailwindcss">
        :root {
            --domsteak-red: #D32F2F;--domsteak-charcoal: #1e293b;--domsteak-gold: #c5a065;--bg-soft-grey: #f3f4f6;
            --card-white: #ffffff;
        }
        body {
...
<header class="bg-[var(--domsteak-charcoal)] text-white h-16 flex items-center justify-between px-6 shadow-md z-10">
...
<h1 class="font-bold text-lg tracking-wide">POS <span class="text-red-400">Domsteak</span></h1>
</div>
...
<div class="h-2 w-full bg-gradient-to-r from-[var(--domsteak-charcoal)] via-red-600 to-[var(--domsteak-charcoal)]"></div>
<div class="p-8 flex flex-col items-center text-center">
<div class="relative mb-6">
<div class="w-24 h-24 rounded-full border-4 border-[var(--domsteak-gold)] p-1 shadow-lg bg-white mx-auto flex items-center justify-center overflow-hidden">
...
<input class="block w-full pl-10 pr-3 py-3 border border-gray-200 rounded-lg bg-gray-50 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[var(--domsteak-red)] focus:border-transparent transition-all sm:text-sm tracking-widest text-center" id="pin" name="pin" placeholder="••••••" type="password"/>
</div>
</div>
<button class="w-full bg-[var(--domsteak-red)] hover:bg-red-800 text-white font-semibold py-3.5 px-4 rounded-lg shadow-lg shadow-red-500/30 transition-all duration-200 transform hover:translate-y-[-1px] active:translate-y-[0px] flex items-center justify-center gap-2" type="button">
...
<a class="hover:text-[var(--domsteak-red)] transition" href="#">Need Help?</a>
</div>
</div>
</div>
</main>
