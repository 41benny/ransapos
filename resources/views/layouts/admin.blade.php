                    ...
                    @php
                        ...
                        $mainNav = [
                            ...
                            [
                                ...
                                'route' => null,
                                'match' => 'admin.products.*|admin.outlets.*|admin.suppliers.*|admin.payment-methods.*|admin.customers.*|admin.coa-accounts.*|admin.cash-accounts.*|admin.expense-categories.*|admin.users.*',
                                'children' => [
