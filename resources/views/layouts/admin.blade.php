                    ...
                    @php
                        ...
                        $mainNav = [
                            ...
                            [
                                ...
                                'route' => null,
                                'match' => 'admin.products.*|admin.product-categories.*|admin.outlets.*|admin.suppliers.*|admin.payment-methods.*|admin.sales-types.*|admin.customers.*|admin.coa-accounts.*|admin.cash-accounts.*|admin.expense-categories.*|admin.users.*|admin.shifts.*',
                                'children' => [
                                    ...
                                    ['label' => 'Shift Absensi', 'route' => 'admin.shifts.index', 'match' => 'admin.shifts.*', 'permission' => 'attendance.shifts.manage'],
