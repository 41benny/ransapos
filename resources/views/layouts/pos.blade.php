        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-4">
                <div class="text-right hidden md:block">
                    ...
                    <p class="text-xs text-white/80">{{ auth()->user()->role->display_name ?? 'Kasir' }} • {{ now()->format('d M, H:i') }}</p>
                </div>
                ...
                <div class="flex items-center gap-2">
                    ...
                    <a href="{{ route('pos.sessions.close') }}" 
                       ...
                       title="Tutup Shift">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" transform="rotate(180 12 12)"/>
                        </svg>
                    ...
                    <form action="{{ route('logout') }}" method="POST">
                        @csrf
                        <button type="submit" class="p-2 bg-red-500/80 hover:bg-red-600 rounded-lg text-white transition" title="Logout">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
