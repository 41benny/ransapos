        ...
        <div class="card bg-white p-6">
            ...
            <div class="table-container overflow-x-auto">
                <table class="table-modern" id="productsTable" style="table-layout: auto;">
                    <thead>
                        <tr>
                            <th class="resizable !py-2" style="min-width: 100px; position: relative;">
                                SKU
                                <div class="resize-handle"></div>
                            </th>
                            <th class="resizable !py-2" style="min-width: 150px; position: relative;">
                                Nama Produk
                                <div class="resize-handle"></div>
                            </th>
                            <th class="resizable !py-2" style="min-width: 120px; position: relative;">
                                Kategori
                                <div class="resize-handle"></div>
                            </th>
                            <th class="resizable !py-2" style="min-width: 120px; position: relative;">
                            ...
                            <th class="resizable !py-2" style="min-width: 80px; position: relative;">
                                Satuan
                                <div class="resize-handle"></div>
                            </th>
                            <th class="resizable !py-2" style="min-width: 100px; position: relative;">
                            ...
                            <th class="!py-2" style="min-width: 100px;">Aksi</th>
                        </tr>
                        <!-- Filter Row -->
                        <!-- Filter Row -->
