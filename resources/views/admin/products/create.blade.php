        ...
        <div class="ui-card bg-white rounded-xl shadow-sm border border-gray-100">
            ...
            <div class="p-6 space-y-8">
                    ...
                    <div class="lg:col-span-3 space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <p class="mt-1 text-xs text-gray-500">Bisa dikosongkan. Sistem akan buat SKU unik otomatis saat simpan.</p>
                                @error('sku')
                ...
                <div class="p-5 border border-gray-200 rounded-xl">
                    ...
                    <p class="text-xs text-gray-500 mt-1 mb-4">Harga mengikuti tipe penjualan di POS. Default menggunakan Reguler.</p>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const productForm = document.querySelector('form[action="{{ route('admin.products.store') }}"]');
        ...
        // Restore checked state from old values
        @if(old('price_levels'))
            @foreach($priceLevels as $levelKey => $levelLabel)
                @php
