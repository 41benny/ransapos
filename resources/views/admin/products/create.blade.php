    ...
    <form action="{{ route('admin.products.store') }}" method="POST">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100">
            ...
            <div class="p-6 border-b border-gray-100">
                ...
                <p class="text-sm text-gray-500 mt-1">Data lengkap produk yang akan ditambahkan</p>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            required
                        >
                            <option value="finished_good" {{ old('product_type', 'finished_good') == 'finished_good' ? 'selected' : '' }}>Produk Jadi</option>
                            <option value="raw_material" {{ old('product_type', 'finished_good') == 'raw_material' ? 'selected' : '' }}>Bahan Baku</option>
                            <option value="service" {{ old('product_type', 'finished_good') == 'service' ? 'selected' : '' }}>Jasa</option>
                        </select>
                        @error('product_type')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
