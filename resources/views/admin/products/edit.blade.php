                        ...
                        <div class="mt-4 space-y-3">
                            ...
                            <label class="flex items-center gap-3 cursor-pointer">
                                <input
                                    ...
                                    value="1"
                                    {{ old('is_online_order_available', $product->is_online_order_available ?? false) ? 'checked' : '' }}
                                    class="w-5 h-5 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500"
                                >
                            ...
                            <div id="outlet-selector-wrap" class="hidden pt-1">
                                ...
                                >
                                    @foreach($outlets as $outlet)
                                        <option
                                            value="{{ $outlet->id }}"
                                            {{ in_array($outlet->id, $selectedOutlets) ? 'selected' : '' }}
                                        >
                                            {{ $outlet->name }}
                                        </option>
                                    @endforeach
                        ...
                        <table class="min-w-full border border-gray-200 rounded-lg overflow-hidden">
                            ...
                            <tbody>
                                @foreach($priceLevels as $levelKey => $levelLabel)
                                    @php
                                        $defaultPrice = data_get($product->price_levels, $levelKey);
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="relative">
                                                ...
                                                <input
                                                    ...
                                                    value="{{ old('price_levels.' . $levelKey, $defaultPrice ?? '') }}"
                                                    min="0"
                                                    step="0.01"
