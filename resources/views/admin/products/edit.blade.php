                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div>
                                    ...
                                    <select name="product_type" id="product_type"
                                        ...
                                        required>
                                        <option value="finished_good" {{ old('product_type', $product->product_type) == 'finished_good' ? 'selected' : '' }}>Produk Jadi
                                        </option>
                                    ...
                                    <div class="p-4 space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <div class="flex items-center gap-2 max-w-md">
                                                ...
                                                <button type="button" class="ui-btn ui-btn-secondary ui-btn-sm btn btn-secondary btn-sm copy-to-all-outlets-btn"
                                                    data-level="{{ $levelKey }}"
                                        ...
                                        <div class="outlet-selection-section hidden" data-level="{{ $levelKey }}">
                                                        ...
                                                        <div class="outlet-price-row border-b border-gray-100 last:border-0 hover:bg-gray-50 transition-colors"
                                                            ...
                                                            <label class="flex items-center gap-3 px-3 py-2.5 cursor-pointer">
                                                                <input type="checkbox"
                                                                    ...
                                                                    data-level="{{ $levelKey }}" data-outlet-id="{{ $outlet->id }}"
                                                                    {{ $outletPrice ? 'checked' : '' }}>
                                            ...
                                            <p class="text-xs text-gray-500 mt-2">
                                                ...
                                                Centang outlet untuk mengatur harga khusus. Kosongkan input untuk menggunakan
                                                harga
                                                default.
                                            </p>
                                        </div>
