...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="mb-6">
        <div class="flex items-center space-x-2 text-sm text-gray-600 mb-2">
            ...
            <span>/</span>
            <a href="{{ route('admin.cash-accounts.show', $account) }}" class="hover:text-indigo-600">{{ $account->code }}</a>
            <span>/</span>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 text-sm text-gray-900">
                                    ...
                                    @if($transaction->reference_type)
                                        <div class="text-xs text-gray-500 mt-1">Ref: {{ ucfirst($transaction->reference_type) }} #{{ $transaction->reference_id }}</div>
                                    @endif
                                </td>
