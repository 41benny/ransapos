        ...
        @if($viewType === 'payment-method')
            <div class="space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {{-- KPI Cards --}}
                            <div class="group relative rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition-all hover:shadow-lg">
                                <span class="block text-[10px] font-normal uppercase tracking-[0.2em] text-slate-400 mb-2">Total Transactions</span>
                                <div class="flex items-center gap-4">
                                    <div class="flex h-12 w-12 items-center justify-center rounded-xl bg-indigo-50 text-indigo-600 transition-colors group-hover:bg-indigo-600 group-hover:text-white">
                                        <i class="fas fa-receipt text-lg"></i>
                                    </div>
                                    <h3 class="text-3xl font-normal text-slate-800 tracking-tight">{{ number_format($summary['total_transactions'] ?? 0) }}</h3>
                                </div>
                            </div>

                            <div class="group relative rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition-all hover:shadow-lg">
                                <span class="block text-[10px] font-normal uppercase tracking-[0.2em] text-slate-400 mb-2">Total Amount</span>
                                <div class="flex items-center gap-4">
                                    <div class="flex h-12 w-12 items-center justify-center rounded-xl bg-emerald-50 text-emerald-600 transition-colors group-hover:bg-emerald-600 group-hover:text-white">
                                        <i class="fas fa-coins text-lg"></i>
                                    </div>
                                    <h3 class="text-3xl font-normal text-slate-800 tracking-tight">Rp {{ number_format($summary['total_amount'] ?? 0, 0, ',', '.') }}</h3>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="rounded-xl bg-slate-50 p-4 border border-slate-100">
                                        ...
                                        <div class="space-y-2">
                                            ...
                                            <div class="flex items-center justify-between text-xs">
                                                ...
                                                <span class="font-normal text-rose-500">{{ $fmt($summary['void_total'] ?? 0) }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="flex items-center justify-between group">
                                        <div>
                                            ...
                                            <div class="text-[11px] text-slate-400 mt-0.5">Qty:
                                                {{ number_format($productRow->total_qty) }}</div>
                                        </div>
                                        <span
                    ...
                    <div class="grid grid-cols-1 gap-3 md:grid-cols-5">
                        <div class="rounded-xl border border-slate-200 bg-slate-50 p-4">
                            ...
                            <div class="mt-1 text-xl font-normal text-slate-900">Rp
                                {{ number_format($summary['totals']['asset'] ?? 0, 0, ',', '.') }}</div>
                        ...
                        <div class="rounded-xl border border-slate-200 bg-slate-50 p-4">
                            ...
                            <div class="mt-1 text-xl font-normal text-slate-900">Rp
                                {{ number_format($summary['totals']['liability'] ?? 0, 0, ',', '.') }}</div>
                            <a class="mt-2 inline-flex text-xs font-normal text-indigo-700 hover:text-indigo-900"
                        ...
                        <div class="rounded-xl border border-slate-200 bg-slate-50 p-4">
                            ...
                            <div class="mt-1 text-xl font-normal text-slate-900">Rp
                                {{ number_format($summary['totals']['equity'] ?? 0, 0, ',', '.') }}</div>
                            <a class="mt-2 inline-flex text-xs font-normal text-indigo-700 hover:text-indigo-900"
                        ...
                        <div class="rounded-xl border border-slate-200 bg-slate-50 p-4">
                            ...
                            <div class="mt-1 text-xl font-normal text-slate-900">Rp
                                {{ number_format($summary['totals']['liability_equity'] ?? 0, 0, ',', '.') }}</div>
                        </div>
                        <div class="rounded-xl border border-slate-200 bg-slate-50 p-4">
                    ...
                    'reference_scope' => 'sales_cogs',
                                ...
                                <div class="rounded-xl border border-slate-200 bg-slate-50 p-4">
                                    ...
                                    <div class="mt-2 text-2xl font-normal text-emerald-700">Rp
                                        {{ number_format($summary['gross_profit'] ?? 0, 0, ',', '.') }}</div>
                                    <div class="mt-1 text-xs text-slate-500">Margin
                                        {{ number_format($summary['gross_profit_margin'] ?? 0, 2) }}%</div>
                                </div>
                                <div class="rounded-xl border border-slate-200 bg-slate-50 p-4">
                                    ...
                                    <div class="mt-1 text-xs text-slate-500">Margin
                                        {{ number_format($summary['net_profit_margin'] ?? 0, 2) }}%</div>
                                </div>
                            </div>
                                                                                                ...
                                                                                                <div class="space-y-1">
                                                                                                    @foreach($group['accounts'] as $account)
                                                                                                                                                                        <div class="flex items-center justify-between text-xs text-slate-600">
                                                                                                                                                                            ...
                                                                                                                                                                            <a class="font-normal text-slate-700 hover:text-indigo-700"
                    ...
                    <div class="grid grid-cols-1 gap-3 md:grid-cols-3">
                        <div class="rounded-xl border border-slate-200 bg-slate-50 p-4">
                            ...
                            <div class="mt-1 text-2xl font-normal text-slate-900">Rp
                                {{ number_format($summary['total_cash'] ?? 0, 0, ',', '.') }}</div>
                            <a class="mt-2 inline-flex text-xs font-normal text-indigo-700 hover:text-indigo-900"
                                href="{{ route('admin.reports.catalog.show', array_merge(['slug' => 'cash-bank-detail'], $auditBase)) }}">
                                Audit Akun Kas
                            </a>
                        ...
                        <div class="rounded-xl border border-slate-200 bg-slate-50 p-4">
                            ...
                            <div class="mt-1 text-2xl font-normal text-slate-900">Rp
                                {{ number_format($summary['total_bank'] ?? 0, 0, ',', '.') }}</div>
                            <a class="mt-2 inline-flex text-xs font-normal text-indigo-700 hover:text-indigo-900"
                                href="{{ route('admin.reports.catalog.show', array_merge(['slug' => 'cash-bank-detail'], $auditBase)) }}">
                                Audit Per Akun
                            </a>
                        ...
                        <div class="rounded-xl border border-slate-200 bg-slate-50 p-4">
                            ...
                            <div class="mt-1 text-2xl font-normal text-slate-900">Rp
                                {{ number_format($summary['total_balance'] ?? 0, 0, ',', '.') }}</div>
                        </div>
                    </div>
                            ...
                            <tbody class="divide-y divide-slate-100">
                                @forelse($rows as $row)
                                    <tr>
                                        ...
                                        <td class="px-4 py-3 text-right font-normal text-slate-900">Rp
                                            {{ number_format($row->ending_balance, 0, ',', '.') }}</td>
                ...
                <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                    <div class="mb-4 grid grid-cols-1 gap-3 md:grid-cols-4">
                        <div class="rounded-xl border border-slate-200 bg-slate-50 p-4">
                            ...
                            <div class="mt-1 text-xl font-normal text-slate-900">Rp
                                {{ number_format($summary['beginning_balance'] ?? 0, 0, ',', '.') }}</div>
                        </div>
                        <div class="rounded-xl border border-slate-200 bg-slate-50 p-4">
                                ...
                                @forelse($rows as $row)
                                    <tr>
                                        ...
                                        <td class="px-4 py-3 text-right text-slate-700">Rp
                                            {{ number_format($row->beginning_balance, 0, ',', '.') }}</td>
                                        <td class="px-4 py-3 text-right text-emerald-700">Rp
                                            {{ number_format($row->total_in, 0, ',', '.') }}</td>
                                        <td class="px-4 py-3 text-right text-rose-700">Rp
                                            {{ number_format($row->total_out, 0, ',', '.') }}</td>
                                        <td class="px-4 py-3 text-right font-normal text-slate-900">Rp
                                            {{ number_format($row->ending_balance, 0, ',', '.') }}</td>
                                        <td class="px-4 py-3 text-right">
                                            <a class="inline-flex text-xs font-normal text-indigo-700 hover:text-indigo-900"
                ...
                <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                    <div class="mb-4 grid grid-cols-1 gap-3 md:grid-cols-4">
                        ...
                        <div class="rounded-xl border border-slate-200 bg-slate-50 p-4">
                            ...
                            <div class="mt-1 text-xl font-normal text-slate-900">{{ number_format($summary['row_count'] ?? 0) }}</div>
                        </div>
                    </div>
                                ...
                                @forelse($rows as $row)
                                    <tr>
                                        <td class="px-4 py-3 text-slate-700">
                                            {{ \Carbon\Carbon::parse($row->transaction_date)->format('d M Y') }}</td>
                                        ...
                                        <td class="px-4 py-3 text-right text-emerald-700">
                                            {{ $row->type === 'in' ? 'Rp ' . number_format($row->amount, 0, ',', '.') : '-' }}</td>
                                        <td class="px-4 py-3 text-right text-rose-700">
                                            {{ $row->type === 'out' ? 'Rp ' . number_format($row->amount, 0, ',', '.') : '-' }}</td>
                                        <td class="px-4 py-3 text-slate-700">
                                            {{ $row->description }}
                ...
                <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                    <div class="mb-4 grid grid-cols-1 gap-3 md:grid-cols-4">
                        ...
                        <div class="rounded-xl border border-slate-200 bg-slate-50 p-4">
                            ...
                            <div class="mt-2 text-2xl font-normal text-emerald-700">Rp
                                {{ number_format($summary['total_sales'] ?? 0, 0, ',', '.') }}</div>
                        </div>
                        <div class="rounded-xl border border-slate-200 bg-slate-50 p-4">
                            ...
                            <div class="mt-2 text-2xl font-normal text-rose-700">Rp
                                {{ number_format($summary['total_hpp'] ?? 0, 0, ',', '.') }}</div>
                        </div>
                        <div class="rounded-xl border border-slate-200 bg-slate-50 p-4">
                            <div class="text-xs font-normal uppercase tracking-wide text-slate-500">Laba Kotor</div>
                            <div
                            ...
                            <div class="mt-1 text-xs font-normal text-slate-500">Margin:
                                {{ number_format($summary['gross_margin_percent'] ?? 0, 2) }}%</div>
                        </div>
                    </div>
                            ...
                            <tbody class="divide-y divide-slate-100">
                                @forelse($rows as $row)
                                    <tr>
                                        <td class="px-4 py-3 font-mono text-xs text-slate-700">{{ $row->transaction_number }}</td>
                                        <td class="px-4 py-3 text-slate-700">
                                            {{ \Carbon\Carbon::parse($row->sale_date)->format('d/m/Y') }}</td>
                                        <td class="px-4 py-3 text-slate-700">{{ $row->outlet_name }}</td>
                                        ...
                                        <td class="px-4 py-3 text-right font-normal text-rose-700">Rp
                                            {{ number_format($row->hpp_amount, 0, ',', '.') }}</td>
                                        <td
