    ...
    <div class="p-6 border-b border-gray-100 no-print">
        <form method="GET" action="{{ route('admin.reports.sales.products') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div class="md:col-span-4 flex space-x-2">
                ...
                <a href="{{ route('admin.reports.sales.products.export', array_merge(request()->query(), ['format' => 'xlsx'])) }}" class="px-4 py-2 bg-emerald-50 border border-emerald-200 hover:bg-emerald-100 text-emerald-700 rounded-lg transition">
                    Export Excel
                </a>
                <a href="{{ route('admin.reports.sales.products.export', array_merge(request()->query(), ['format' => 'pdf'])) }}" class="px-4 py-2 bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 rounded-lg transition">
                    Export PDF
                </a>
