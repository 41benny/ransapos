...
@section('page-subtitle', 'Buat kategori baru untuk pengelompokan produk')
        ...
        <form action="{{ route('admin.product-categories.store') }}" method="POST">
            ...
            <div class="ui-card bg-white rounded-xl shadow-sm border border-gray-100">
                <div class="p-6 border-b border-gray-100">
                    ...
                    <p class="text-sm text-gray-500 mt-1">Kategori aktif akan muncul di pilihan produk dan POS</p>
                </div>
