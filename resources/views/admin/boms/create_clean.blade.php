...
{!! json_encode($rawMaterials->map(function($raw) {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var rawMaterials = JSON.parse(document.getElementById('raw-materials-data').textContent);
    var componentIndex = parseInt(document.getElementById('component-index-data').textContent);
