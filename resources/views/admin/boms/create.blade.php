...
@section('title', 'Tambah BOM')
    ...
    @section('content')
                ...
                <form action="{{ route('admin.boms.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                <label class="flex items-center cursor-pointer">
                                    <input type="checkbox"
                                        class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500" id="is_active"
                        ...
                        <div>
                                        ...
                                        <div class="component-row bg-gray-50 border border-gray-200 rounded-lg p-4">
                                            <div class="grid grid-cols-1 md:grid-cols-12 gap-3">
                                                ...
                                                <div class="md:col-span-1 flex items-end">
                                                    <button type="button"
                                                        class="p-2 text-red-500 hover:text-red-700 hover:bg-red-50 rounded-lg transition-colors duration-150 remove-component"
                            ...
                            <button type="button" id="add-component" class="mt-4 btn btn-secondary">
        ...
        <div id="app-data" style="display: none;" data-component-index="{{ old('components') ? count(old('components')) : 1 }}"
            data-raw-materials="{{ json_encode($rawMaterials->map(function ($raw) {
