        ...
        <div class="ui-card bg-white rounded-xl shadow-sm border border-gray-100 page-card-fill">
            ...
            <div class="p-6 border-b border-gray-100">
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('admin.suppliers.create') }}" class="ui-btn ui-btn-primary btn btn-primary inline-flex items-center">
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center space-x-2">
                                        <button class="ui-btn ui-btn-ghost ui-btn-sm p-2 text-blue-600 hover:bg-blue-50 rounded-lg transition">
                                        ...
                                        <button class="ui-btn ui-btn-ghost ui-btn-sm p-2 text-amber-700 hover:bg-amber-50 rounded-lg transition">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                            </svg>
                                        </button>
                                        <button class="ui-btn ui-btn-ghost ui-btn-sm p-2 text-red-600 hover:bg-red-50 rounded-lg transition">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
