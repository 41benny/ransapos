            ...
            <div class="ui-card bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div class="flex flex-col gap-1.5">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name', $user->name) }}" required
                                class="ui-input w-full px-4 py-2.5 text-[11.5px] font-normal bg-white border border-slate-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all placeholder:text-slate-400 @error('name') border-rose-500 @enderror">
                        ...
                        <div class="flex flex-col gap-1.5">
                            ...
                            <input type="email" name="email" id="email" value="{{ old('email', $user->email) }}"
                                class="ui-input w-full px-4 py-2.5 text-[11.5px] font-normal bg-white border border-slate-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all placeholder:text-slate-400 @error('email') border-rose-500 @enderror">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div class="flex flex-col gap-1.5">
                            ...
                            <select name="role_id" id="role_id" required
                                class="ui-input w-full px-4 py-2.5 text-[11.5px] font-normal bg-white border border-slate-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all ring-0 outline-none @error('role_id') border-rose-500 @enderror">
                        ...
                        <div class="flex flex-col gap-1.5">
                            ...
                            <select name="outlet_id" id="outlet_id"
                                class="ui-input w-full px-4 py-2.5 text-[11.5px] font-normal bg-white border border-slate-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all ring-0 outline-none">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div class="flex flex-col gap-1.5">
                            ...
                            <input type="password" name="password" id="password"
                                class="ui-input w-full px-4 py-2.5 text-[11.5px] font-normal bg-white border border-slate-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all placeholder:text-slate-400 @error('password') border-rose-500 @enderror"
                        ...
                        <div class="flex flex-col gap-1.5">
                            ...
                            <input type="password" name="password_confirmation" id="password_confirmation"
                                class="ui-input w-full px-4 py-2.5 text-[11.5px] font-normal bg-white border border-slate-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all placeholder:text-slate-400">
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center gap-2">
                            <button type="button" id="checkAllUserPermissions"
                                class="ui-btn ui-btn-ghost px-3 py-1.5 rounded-lg border border-slate-200 text-[10px] text-slate-600 hover:border-indigo-100 hover:text-indigo-600 transition-all">
                                Ceklis Semua
                            </button>
                            <button type="button" id="uncheckAllUserPermissions"
                                class="ui-btn ui-btn-ghost px-3 py-1.5 rounded-lg border border-slate-200 text-[10px] text-slate-600 hover:border-rose-100 hover:text-rose-600 transition-all">
                                Hapus Semua
                            </button>
                        </div>
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                            @foreach($permissionsByModule as $module => $permissions)
                                <div class="ui-card rounded-xl border border-slate-200 overflow-hidden">
                                    <div class="px-4 py-3 bg-slate-50 border-b border-slate-100 flex items-center justify-between">
                                        ...
                                        <button type="button" class="module-toggle ui-btn ui-btn-ghost text-[10px] text-indigo-600" data-module="{{ $module }}">
                                            Toggle
                                        </button>
                                    </div>
                ...
                <div class="p-6 border-t border-slate-100 bg-slate-50/50 flex items-center justify-end gap-3 no-print">
                    <a href="{{ route('admin.users.index') }}"
                        class="ui-btn ui-btn-ghost px-4 py-2.5 text-xs font-normal text-slate-500 hover:text-slate-700 transition-all active:scale-95">
                        Batal
                    </a>
                    <button type="submit"
                        class="ui-btn ui-btn-primary inline-flex items-center gap-2 rounded-lg bg-indigo-600 px-6 py-2.5 text-xs font-normal text-white shadow-sm transition-all hover:bg-indigo-700 active:scale-95">
        ...
        <form action="{{ route('admin.users.set-pin', $user) }}" method="POST"
            ...
            <div class="ui-card bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                    ...
                    <div class="max-w-md">
                        ...
                        <div class="flex flex-col sm:flex-row gap-3 mt-1.5">
                            <input type="text" name="pin" id="attendance_pin" inputmode="numeric" pattern="[0-9]{6}"
                                ...
                                class="ui-input flex-1 px-4 py-2.5 text-[14px] font-mono tracking-[0.5em] text-center bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all placeholder:tracking-normal placeholder:text-[11px] @error('pin', 'setPin') border-rose-500 @enderror"
                                placeholder="------">
                            <button type="button" id="generateAttendancePin"
                                class="ui-btn ui-btn-ghost px-4 py-2.5 text-xs font-normal text-slate-600 bg-white border border-slate-200 rounded-lg hover:bg-slate-50 transition-all active:scale-95 shadow-sm">
                                Generate PIN
                            </button>
                        </div>
                ...
                <div class="p-6 border-t border-slate-100 bg-slate-50/50 flex items-center justify-end no-print">
                    <button type="submit"
                        class="ui-btn ui-btn-primary inline-flex items-center gap-2 rounded-lg bg-emerald-600 px-6 py-2.5 text-xs font-normal text-white shadow-sm transition-all hover:bg-emerald-700 active:scale-95">
