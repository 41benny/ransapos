...
<div class="px-6 py-6 page-card-fill">
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex gap-2">
            <a href="{{ route('admin.stocks.adjustment') }}" class="bg-indigo-600 text-white px-4 py-2 rounded-lg hover:bg-indigo-700 transition">
                <i class="fas fa-adjust mr-2"></i>Stock Adjustment
            </a>
            <a href="{{ route('admin.stock-transfers.create') }}" class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition">
        ...
        <div class="bg-white rounded-lg shadow p-4">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900">Rp {{ number_format($stats['total_value'], 0, ',', '.') }}</p>
                </div>
    ...
    <div class="bg-white rounded-lg shadow p-4 mb-6">
        <form method="GET" action="{{ route('admin.stocks.index') }}" class="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <div>
                ...
                <input type="text" name="search" value="{{ request('search') }}" placeholder="Nama atau SKU..." class="w-full border-gray-300 rounded-lg">
            </div>

            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Filter</label>
                <select name="low_stock" class="w-full border-gray-300 rounded-lg">
            ...
            <div class="flex items-end gap-2">
                ...
                <a href="{{ route('admin.stocks.index') }}" class="bg-gray-200 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-300">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase">Nilai (HPP)</th>
                    ...
                    @forelse($stocks as $stock)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 text-right">
                                <span class="font-semibold text-gray-900">{{ number_format($stock->quantity, 2) }}</span>
                            ...
                            <td class="px-6 py-4 text-right text-sm text-gray-900">
                                Rp {{ number_format($stock->quantity * ($stock->product->purchase_price ?? 0), 0, ',', '.') }}
                            </td>
    ...
    <div class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
        <a href="{{ route('admin.stocks.mutations') }}" class="bg-white rounded-lg shadow p-4 hover:shadow-lg transition">
        ...
        <a href="{{ route('admin.stock-transfers.index') }}" class="bg-white rounded-lg shadow p-4 hover:shadow-lg transition">
            <div class="flex items-center">
        ...
        <a href="{{ route('admin.purchases.index') }}" class="bg-white rounded-lg shadow p-4 hover:shadow-lg transition">
            <div class="flex items-center">
