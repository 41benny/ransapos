...
@section('page-subtitle', 'Isi form di bawah untuk menambah outlet baru')
    ...
    <form action="{{ route('admin.outlets.store') }}" method="POST">
        ...
        <div class="ui-card bg-white rounded-xl shadow-sm border border-gray-100">
            ...
            <div class="p-6 border-b border-gray-100">
                ...
                <p class="text-sm text-gray-500 mt-1">Lengkapi data cabang/toko yang akan ditambahkan</p>
            </div>
